...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MOKEN features */
        {"moken", "masternode", &masternode, true, true, false},
        {"moken", "listmasternodes", &listmasternodes, true, true, false},
        {"moken", "getmasternodecount", &getmasternodecount, true, true, false},
        {"moken", "masternodeconnect", &masternodeconnect, true, true, false},
        {"moken", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"moken", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"moken", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"moken", "masternodecurrent", &masternodecurrent, true, true, false},
        {"moken", "masternodedebug", &masternodedebug, true, true, false},
        {"moken", "startmasternode", &startmasternode, true, true, false},
        {"moken", "createmasternodekey", &createmasternodekey, true, true, false},
        {"moken", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"moken", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"moken", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"moken", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"moken", "getmasternodescores", &getmasternodescores, true, true, false},
        {"moken", "mnbudget", &mnbudget, true, true, false},
        {"moken", "preparebudget", &preparebudget, true, true, false},
        {"moken", "submitbudget", &submitbudget, true, true, false},
        {"moken", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"moken", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"moken", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"moken", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"moken", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"moken", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"moken", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"moken", "checkbudgets", &checkbudgets, true, true, false},
        {"moken", "mnsync", &mnsync, true, true, false},
        {"moken", "spork", &spork, true, true, false},
        {"moken", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzmokseed", &getzmokseed, false, false, true},
        {"zerocoin", "setzmokseed", &setzmokseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzmok", &searchdzmok, false, false, true},
        {"zerocoin", "dzmokstate", &dzmokstate, false, false, true}
...
{
    return "> moken-cli " + methodname + " " + args + "\n";
}
