                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMOKPathCustom = GetArg("-zmokbackuppath", "");
    ...
    if(!strzMOKPathCustom.empty()) {
        ui->wallet_customzmokbackuppath->setText(QString::fromStdString(strzMOKPathCustom));
        ui->wallet_customzmokbackuppath_label->setVisible(true);
        ui->wallet_customzmokbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMOKPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MOKEN RPC console.") + "<br>" +
