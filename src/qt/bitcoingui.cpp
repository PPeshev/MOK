                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MOKEN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MOKEN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and moken: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMOK"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MOKEN Core"), this);
    aboutAction->setStatusTip(tr("Show information about MOKEN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MOKEN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MOKEN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MOKEN addresses"));
    ...
    openAction->setStatusTip(tr("Open a MOKEN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MOKEN Core help message to get a list with possible MOKEN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MOKEN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MOKEN network", "", count));
}
...
{
    QString strTitle = tr("MOKEN Core"); // default title
