...
/* Moken GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MOKEN"
#define QAPP_ORG_DOMAIN "moken.org"
#define QAPP_APP_NAME_DEFAULT "MOKEN-Qt"
#define QAPP_APP_NAME_TESTNET "MOKEN-Qt-testnet"
