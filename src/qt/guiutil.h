...
/** Utility functions used by the MOKEN Qt UI.
 */
namespace GUIUtil
{
...
// Render MOKEN addresses in monospace font
...
// Parse "moken:" URI into recipient object, return true on successful parsing
