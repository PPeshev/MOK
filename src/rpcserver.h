...
extern UniValue setzmokseed(const UniValue& params, bool fHelp);
extern UniValue getzmokseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzmok(const UniValue& params, bool fHelp);
extern UniValue dzmokstate(const UniValue& params, bool fHelp);
