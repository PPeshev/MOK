...
This means one can have an always-on mokend instance running, and another local mokend/moken-qt instance which connects to this node and receives blocks from it.
