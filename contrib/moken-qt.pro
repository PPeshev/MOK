...
RESOURCES += src/qt/moken.qrc src/qt/moken_locale.qrc

TRANSLATIONS += src/qt/locale/moken_bg.ts \
                src/qt/locale/moken_de.ts \
                src/qt/locale/moken_en.ts \
                src/qt/locale/moken_es.ts \
                src/qt/locale/moken_fi.ts \
                src/qt/locale/moken_fr.ts \
                src/qt/locale/moken_it.ts \
                src/qt/locale/moken_ja.ts \
                src/qt/locale/moken_pl.ts \
                src/qt/locale/moken_pt.ts \
                src/qt/locale/moken_ru.ts \
                src/qt/locale/moken_sk.ts \
                src/qt/locale/moken_sv.ts \
                src/qt/locale/moken_vi.ts \
                src/qt/locale/moken_zh_CN.ts \
                src/qt/locale/moken_zh_TW.ts
