...
In order to support loading of multiple wallets in moken-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is moken.cpp.
...
Changes to moken.cpp
----------------------
moken.cpp is the entry point into moken-qt, and as such, will require some minor modifications to provide hooks for
