Contributing to MOKEN Core
============================

The MOKEN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MOKEN Core project, and is not to be
confused with overall MOKEN Network Protocol consensus changes.

Whether a pull request is merged into MOKEN Core rests with the project merge
...
Patches that change MOKEN consensus rules are considerably more involved than
...
Where a patch set proposes to change the MOKEN consensus, it must have been
...
The project leader is the release manager for each MOKEN Core release.
