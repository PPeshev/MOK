...
#   c) node1 mines 32 blocks, so now node 0 has 60001mok, node 1 has 4250mok, node2 has none.
#   d) node0 sends 601 mok to node2, in two transactions (301 mok, then 300 mok).
